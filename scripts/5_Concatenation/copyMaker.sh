...
#Permet de séparer dans un nouveau répertoire les orthogroupes que nous avons chois comme marqueurs après observation de la répartition des RF
...
echo "Début de la copie des arbres"
...
echo "fin de la copie des arbres"